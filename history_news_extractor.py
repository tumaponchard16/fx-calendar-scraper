...
def extract_all_history_and_news(csv_file=None, base_date_param="day=oct6.2025"):
    """
    ...
    """
    logger = configure_logger(__name__, build_log_file_path("history_news_extractor"))
    ...
    logger.info(f"Starting history and news extraction from {display_path(resolved_csv_file)}")
    ...
    try:
        for i, event in enumerate(events):
            ...
            playwright, browser, context, page = setup_browser(logger, "history and news extraction")
...
Examples:
  ...
  python3 history_news_extractor.py --date-param "day=oct22.2025"
    python3 history_news_extractor.py --csv-file outputs/oct-22-2025/day=oct22.2025.csv --date-param "day=oct22.2025"
        """
    )
